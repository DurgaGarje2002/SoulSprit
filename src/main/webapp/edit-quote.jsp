...
<%
    ...
    if (idParam == null) {
        response.sendRedirect("manage-quotes.jsp");
        return;
    }
    
    int quoteId = Integer.parseInt(idParam);
    QuoteDAO quoteDAO = new QuoteDAO();
    Quote quote = quoteDAO.getQuoteById(quoteId);
    
    if (quote == null) {
        session.setAttribute("error", "Quote not found!");
        response.sendRedirect("manage-quotes.jsp");
        return;
    }
...
<body>
    <div class="admin-container">
        ...
        <div class="main-content">
            <div class="topbar">
                <h2><i class="fas fa-edit"></i> Edit Quote</h2>
            ...
            <div class="content-area">
                ...
                <div class="form-container">
                    <div class="info-box">
                        ...
                        Editing Quote ID: <strong><%= quote.getQuoteId() %></strong>
                    </div>
                    
                    <form action="UpdateQuoteServlet" method="post" onsubmit="return validateForm()">
                        <input type="hidden" name="quoteId" value="<%= quote.getQuoteId() %>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="quoteText" 
                                      ...
                                      required><%= quote.getQuoteText() %></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   id="author" 
                                   name="author" 
                                   value="<%= quote.getAuthor() %>"
                                   placeholder="e.g., Buddha, Mahatma Gandhi"
                                   required>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="manage-quotes.jsp" class="btn-outline">
